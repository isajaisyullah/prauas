...
import ujian.percobaan.exceptions.PreexistingEntityException;
...
public class BarangJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("ujian_percobaan_jar_0.0.1-SNAPSHOTPU");
